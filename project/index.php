            ...
            <div class="row">
                <div class=" border-img col-lg-3 col-sm-6">
                    <div class="width-20">
                        ...
                        <div class="head-para">
                            <a href="index2.php">PHTHALOCYANINES</a>
                            <h6> <i>ε Epsilon</i></h6>
                            <h6><i>β Beta</i></h6>
                            <h6><i>α Alpha</i></h6>
                        </div>
                ...
                <div class="col-lg-9 col-sm-6 " style="margin-top: 15.5%;">
                    <div class="first-page">
                        <div class="para">
                            ...
                            <p>Our success is driven by our long-term strategy of continuous operational improvements. The Quality of <span class="bold">J</span>EEKA<i><span class="bold">B</span>LUE </i>is the result of exceptional diligence in the production process. </p>
                        </div>
                        <div class="manufactured">
                            <h5><a href="#">Manufactured Pigments:</a></h5>
                            <div class="epsilon">
                                <h5 class="bold">Pigment Blue 15:6 | ε Epsilon </h5>
                                ...
                                <p><i>PB 15:6 is recommended for Solvent & Water based Automotive, Industrial & Decorative Paints, Digital Inks and Color Filters in LCD panels. </i></p>
                            </div>
                            <div class="beta-15-3">
                                <h5 class="bold">Pigment Blue 15:3 | β Beta</h5>
                            ...
                            <div class="beta-15-4">
                                <h5 class="bold">Pigment Blue 15:4 | β Beta</h5>
